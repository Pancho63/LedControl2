...
public:  
  ...
  public:
    ...
    bool isInt16() { return currentTypeTag() == TYPE_TAG_INT16; }
  ...
  */
  ...
  Message &pushInt16(int16_t i) { return pushPod(TYPE_TAG_INT16, i); }
 ...
 //     case TYPE_TAG_INT16:
  ...
  friend std::ostream &operator<<(std::ostream &os, const Message &msg) {
    ...
    while (arg.nbArgRemaining() && arg.isOk()) {
      ...
      else if (arg.isInt16()) { int16_t i; arg.popInt16(z); os << i; }
